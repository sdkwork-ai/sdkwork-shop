...
Module `sdkwork-shop` · runtime code `shop` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `shop-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `shop-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `shop-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `shop-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `shop.sdkwork.com` | 443 ssl + 80 |
