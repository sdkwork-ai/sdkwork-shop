...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `shop-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `shop-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `shop-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `shop-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `shop.sdkwork.com` | 443 ssl + 80 |
