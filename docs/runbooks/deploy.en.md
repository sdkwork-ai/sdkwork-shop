# Runbook — sdkwork-shop deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-shop-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-shop/bundle`, loads the image, starts
